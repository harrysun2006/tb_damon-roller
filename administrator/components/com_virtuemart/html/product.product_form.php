...
<tr>
      <td width="21%" ><div style="text-align:right;font-weight:bold;">
      <?php echo "new product" ?>:</div>
      </td>
      <td width="79%" ><?php if ($db->sf("product_new")=="Y") { ?>
        <input type="checkbox" name="product_new" value="Y" checked="checked" />
    <?php    }
       else { ?>
        <input type="checkbox" name="product_new" value="Y" />
    <?php }
    ?> </td>
    </tr>
<tr>
      <td width="21%" ><div style="text-align:right;font-weight:bold;">
      <?php echo "will new product" ?>:</div>
      </td>
      <td width="79%" ><?php if ($db->sf("product_willnew")=="Y") { ?>
        <input type="checkbox" name="product_willnew" value="Y" checked="checked" />
    <?php    }
       else { ?>
        <input type="checkbox" name="product_willnew" value="Y" />
    <?php }
    ?> </td>
    </tr>
