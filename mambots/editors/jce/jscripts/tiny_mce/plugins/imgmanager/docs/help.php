...
<table>
    <tr>
        <td>
            ...
            <p><?php echo $imhelp['interface_upload_opt'];?></p>
            <p><img class="help_icon" src="<?php echo $im_url;?>/images/images.gif" border="0" alt="Toggle Image View" title="Toggle Image View" width="20" height="20" /><?php echo $imhelp['interface_mode'];?></p>
            ...
            <p><img class="help_icon" src="<?php echo $im_url;?>/images/thumb.gif" border="0" alt="Is thumbnail" title="Is thumbnail" width="20" height="20" /><?php echo $imhelp['interface_isthumb'];?></p>
            <p><img class="help_icon" src="<?php echo $im_url;?>/images/thumb_create.gif" border="0" alt="Create Thumbnail" title="Create Thumbnail" width="20" height="20" /><?php echo $imhelp['interface_newthumb'];?></p>
            <p><img class="help_icon" src="<?php echo $im_url;?>/images/thumb_delete.gif" border="0" alt="Delete Thumbnail" title="Delete Thumbnail" width="20" height="20" /><?php echo $imhelp['interface_delthumb'];?></p>
        </td>
    </tr>
    <tr>
        <td>
...
<?php $tabs->endTab();?>
<?php $tabs->startTab($imhelp['popup'],"popup-tab");?>
<table>
    <tr>
        <td>
            <p class="help_subtitle"><?php echo $imhelp['popup_desc'];?></p>
            <p><?php echo $imhelp['popup_desc2'];?></p>
            <p><?php echo $imhelp['popup_stage1'];?></p>
            <p><img src="<?php echo $im_url;?>/docs/images/<?php echo $lang;?>/im_popup1.jpg" /></p>
            <p><?php echo $imhelp['popup_stage2'];?></p>
            <p><img src="<?php echo $im_url;?>/docs/images/<?php echo $lang;?>/im_popup2.jpg" /></p>
            <p><?php echo $imhelp['popup_stage3'];?></p>
            <p><img src="<?php echo $im_url;?>/docs/images/<?php echo $lang;?>/im_popup3.jpg" /></p>
            <p><img src="<?php echo $im_url;?>/docs/images/<?php echo $lang;?>/im_popup4.jpg" /></p>
            <p><?php echo $imhelp['popup_stage4'];?></p>
        </td>
    </tr>
</table>
<?php $tabs->endTab();?>
