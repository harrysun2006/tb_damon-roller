...
$base_path = str_replace( 'mambots/editors/jce/jscripts/tiny_mce/plugins/imgmanager/classes/phpthumb', '', str_replace( DIRECTORY_SEPARATOR, '/', dirname(__FILE__) ) );
...
$PHPTHUMB_CONFIG['document_root'] = $base_path;
...
$PHPTHUMB_CONFIG['cache_directory'] = $base_path.'/media/jce_im_cache/';                            // set the cache directory relative to the phpThumb() installation
...
$PHPTHUMB_CONFIG['cache_maxsize'] = 5 * 1024 * 1024; // delete least-recently-accessed cached thumbnails when more than [10MB] of cached files are present (value is maximum bytesize of all cached files)

//$PHPTHUMB_CONFIG['cache_maxfiles'] = null;          // never delete cached thumbnails based on number of cached files
$PHPTHUMB_CONFIG['cache_maxfiles'] = 50;             // delete least-recently-accessed cached thumbnails when more than [500] cached files are present (value is maximum number of cached files to keep)
...
$PHPTHUMB_CONFIG['temp_directory'] = $base_path.'/media/jce_im_temp/';
