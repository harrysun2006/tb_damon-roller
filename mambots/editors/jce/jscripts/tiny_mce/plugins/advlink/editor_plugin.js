...
tinyMCE.importPluginLanguagePack('advlink', tinyMCE.getParam('lang_list'));
...
var TinyMCE_AdvancedLinkPlugin = {
	...
	getControlHTML : function(cn) {
		switch (cn) {
			case "link":
				return tinyMCE.getButtonHTML(cn, 'lang_link_desc', '{$pluginurl}/images/advlink.gif', 'mceAdvLink');
		}
