<?php
/**
* @version $Id: english.php,v 1.15 2005/02/16 01:21:58 eddieajau Exp $
* @package Mambo
...
/*
 simplified_chinese.php for Mambo 4.5.2 
 Mambo4.5.2 前台简体中文包
...
define( '_404', '您要存取的网页不存在。' );
define( '_404_RTS', '回到网站' );
...
DEFINE('_CMN_ARCHIVE','存档');
DEFINE('_CMN_UNARCHIVE','取消存档');
DEFINE('_CMN_TOP','顶端');
...
/** content.php */
DEFINE('_SECTION_ARCHIVE_EMPTY','此单元目前没有存档资料，以后再来。');
DEFINE('_CATEGORY_ARCHIVE_EMPTY','此分类目前没有存档资料，以后再来。');
DEFINE('_HEADER_SECTION_ARCHIVE','单元存档');
DEFINE('_HEADER_CATEGORY_ARCHIVE','分类存档');
DEFINE('_ARCHIVE_SEARCH_FAILURE','没有 %s %s 的存档资料');	// values are month then year
DEFINE('_ARCHIVE_SEARCH_SUCCESS',' %s %s 的存档资料');	// values are month then year
DEFINE('_FILTER','过滤');
...
DEFINE('_THANK_SUB_PUB','感谢您的提交.');//new 1.0.8
