...
<script type=\"text/javascript\" src=\"$mosConfig_live_site/components/$option/js/may.js\"></script>
<link type=\"text/css\" rel=\"stylesheet\" media=\"screen, projection\" href=\"$mosConfig_live_site/components/$option/css/shop.css\" />
<link type=\"text/css\" rel=\"stylesheet\" media=\"screen, projection\" href=\"$mosConfig_live_site/components/$option/css/may.css\" />
" );
                        } else {
      ?>
      ...
      <script type="text/javascript" src="<?php echo "$mosConfig_live_site/components/$option" ?>/js/may.js"></script>
	<link type="text/css" rel="stylesheet" media="screen, projection" href="components/<?php echo $option ?>/css/shop.css" />
	<link type="text/css" rel="stylesheet" media="screen, projection" href="components/<?php echo $option ?>/css/may.css" />
      <?php
			}
